...
screenshareButton.onclick = async () =>{
  if(!statedCallShare){
    ...
    document.getElementById("screenshareButton_img").src = '/static/contacts/video_p2p/icons/stop_screenShare.png'
...
let StopScreenShare = async () =>{
  ...
  document.getElementById("screenshareButton_img").src = '/static/contacts/video_p2p/icons/screen_share.png'
